...
class SalesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $purchaseAmountTotal = $purchase_price * $request->quantity;
        $sellingPricePerUnit = $product->selling_price;
        $totalSellingPricePerUnitCost = $sellingPricePerUnit * $request->quantity;
        $profit = $totalSellingPricePerUnitCost - $purchaseAmountTotal;
