...
class ReportController extends Controller
{
    ...
    {
        $products = Purchage::with(['purchase', 'sales'])->get();
        ...
        $inventoryData = $products->map(function ($product) {
            ...
            $totalPurchaseCost = $product->purchases->sum('total_cost');
            ...
            return [
                ...
                'stock_value' => $product->current_stock * $averageCostPrice,
    ...
    public function exportSalesPDF(Request $request)
    {
        ...
        foreach ($sales as $sale) {
            ...
            $pdf->Cell(40, 8, substr($sale->product->name, 0, 25), 1, 0, 'L');
            ...
            $pdf->Cell(25, 8, '₦' . number_format($sale->profit), 1, 0, 'R');
