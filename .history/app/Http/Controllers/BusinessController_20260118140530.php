...
class BusinessController extends Controller
{
    ...
    public function balanceWallet(Business $business)
    {
        ...
        return $business->productAssignments->sum(function ($assignment) {
            return $assignment->assigned_quantity * $assignment->purchase->purchase_price;
        });
        
        return $business->productAssignments->sum(function($assignment){
                ($assignment->assigned_quantity - $assignment->sold_quantity - $assignment->returned_quantity) * $assignment->purchases->purchase_price;
        });
