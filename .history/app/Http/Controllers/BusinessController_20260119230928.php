...
class BusinessController extends Controller
{
    ...
    {
        return $business->products()->with([
            'purchases:id,product_id,quantity,created_at',
            'assignments:id,product_id,quantity,created_at',
        ])->get()->map(function ($product) {

            $totalPurchased = $product->purchases->sum('quantity');
            $totalAssigned  = $product->productAssignments->sum('assign_quantity');
            ...
            return [
                ...
                'purchase_history' => $product->purchases,
