...
class DashboardController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        $totalStock = Purchase::sum('current_stock');
        ...
        $topProducts = Sale::selectRaw('product_id, SUM(quantity) as total_sold, SUM(total_amount) as total_revenue')
            ->with('product')
            ->groupBy('product_id')
    ...
    public function salesDashboard()
    {
        ...
        $availableProducts = Product::where('current_stock', '>', 0)->get();
