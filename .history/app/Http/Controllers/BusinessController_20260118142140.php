...
class BusinessController extends Controller
{
    ...
    public function balanceWallet(Business $business)
    {
        ...
        return number_format($businessWalletBalance->balance + $totalSales - $currentPurchaseInventory - $historyPurchaseInventory - $expenses - $productAssignment - $totalCreditorBalance + $totalCreditorPaid, 2);
