...
class InventoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            "_token": "KGSUqzCJA9ZCATNhH8Bcmd7EhS4x39mOz4zTkECN",
            "name": "Palm Oil – Big Jerrycan",
            "unit_type": "jerrycan",
            "purchase_price": "25000",
            "selling_price": "26000",
            "current_stock": "250",
            "supplier_name": "Muhammad Garba",
            "notes": "Daga wajen john a lagos nasaro kayan kuma mai inganci ne"
          }
        return $request;
        $request->validate([
    ...
    {
        $product->load(['purchases.user', 'sales.user']);
