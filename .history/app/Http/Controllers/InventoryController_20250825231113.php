...
class InventoryController extends Controller
{
    ...
    public function show($productId)
    {
        ...
        $product = Purchase::with(['product', 'sales'])->findOrFail($productId)->paginate(10);
        // Get paginated sales
$sales = $product->sales()->paginate(10);
        ...
        $adjustmentRecord = AdjustmentProduct::where("purchase_id", $productId)->paginate(10);
