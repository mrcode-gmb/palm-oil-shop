...
class DashboardController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        $totalStaffs = User::where("role", 'is')->get();
        ...
        return view('admin.dashboard', compact(
            'totalProducts', 'totalStock', 'todaySellerProfitPerUnit', 'todayExpenses', 'lowStockProducts',
            'todaySales', 'todayProfit', 'monthlySales', 'monthlyProfit', 'totalStaffs'
