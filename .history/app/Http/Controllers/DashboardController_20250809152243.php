...
class DashboardController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        $sellerProfitPerUnit = Sale::whereDate('sale_date', $today)->sum('seller_profit_per_unit');
        $today = Sale::whereDate('sale_date', $today)->sum('seller_profit_per_unit');
        ...
        return view('admin.dashboard', compact(
            'totalProducts', 'totalStock', 'sellerProfitPerUnit', 'lowStockProducts',
