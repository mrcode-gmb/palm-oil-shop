...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/app-setting/delete/{new}', [AppSettingController::class, 'newDelete'])->name('appSetting.newDelete');galleryDelete
    Route::get('/app-setting/delete/{new}', [AppSettingController::class, 'galleryDelete'])->name('appSetting.galleryDelete');
