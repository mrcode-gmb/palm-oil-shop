...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/Expenses/sales', [ExpensesController::class, 'create'])->name('Expenses.create');
    Route::get('/Expenses/profit', [ExpensesController::class, 'profitReport'])->name('Expenses.profit');
