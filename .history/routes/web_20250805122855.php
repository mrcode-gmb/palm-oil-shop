...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    // Reports (Admin only)
    Route::get('/reports', [ExpensesController::class, 'index'])->name('reports.index');
    Route::get('/reports/sales', [ExpensesController::class, 'salesReport'])->name('reports.sales');
    Route::get('/reports/profit', [ExpensesController::class, 'profitReport'])->name('reports.profit');
    Route::get('/reports/inventory', [ExpensesController::class, 'inventoryReport'])->name('reports.inventory');
    Route::get('/reports/sales/pdf', [ExpensesController::class, 'exportSalesPDF'])->name('reports.sales.pdf');
});
