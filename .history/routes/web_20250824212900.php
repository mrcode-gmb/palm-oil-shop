...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/index/app-settings', [AppSettingController::class, 'index'])->name('appSetting.index');
    ...
    Route::get('/app-setting/fetch/api', [ExpensesController::class, 'inventoryReport'])->name('expenses.inventory');
    // Route::get('/reports/expensive/pdf', [ReportController::class, 'exportExpensivePDF'])->name('reports.expensive.pdf');
