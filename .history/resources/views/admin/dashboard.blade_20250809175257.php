            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Today's Sellers Commissions</dt>
                                <dd class="text-lg font-medium text-gray-900">
                                    ₦{{ number_format($todaySellerProfitPerUnit, 2) }}
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 bg-green-500 rounded-md flex items-center justify-center">
                               ...
                               4-1.79 4-4-1.79-4-4-4zm0-6v2m0 16v2m10-10h-2M4 12H2m15.364-7.364l-1.414 1.414M6.05 17.95l-1.414 1.414m12.728 0l-1.414-1.414M6.05 6.05L4.636 4.636" />
                                </svg>
                            </div>
                        </div>
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Today's Net Profit</dt>
                                <dd class="text-lg font-medium text-gray-900">
                                    ₦{{ number_format($todayProfit - $todaySellerProfitPerUnit - $todayExpenses, 2) }}
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-blue-500 truncate">Total Staffs</dt>
                                <dd class="text-lg font-medium text-gray-900">
                                    {{ $totalStaffs->count() }} items
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach ($lowStockProducts as $product)
                            <div class="bg-red-50 p-3 rounded-md">
                                <p class="text-sm font-medium text-red-800">{{ $product->product->name }} - N{{$product->purchase_price}}</p>
                                <p class="text-xs text-red-600">Only {{ number_format($product->quantity, 1) }}
                                    units left</p>
