            ...
            <div class="p-6">
                <form method="POST" action="{{ route('admin.storeUser') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="email" id="email" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                        @error('email')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-green-700 text-white py-2 px-6 rounded-md">Add Product</button>
                    </div>
                </form>
            </div>
        </div>
