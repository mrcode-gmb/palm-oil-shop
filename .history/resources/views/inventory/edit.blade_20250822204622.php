                ...
                <form method="POST" action="{{ route('inventory.update', $product) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="unit_type" 
                            ...
                            <option value="Customize" {{ old('unit_type', $product->unit_type) == 'Customize' ? 'selected' : '' }}>Litre</option>
                            <option value="Uncustomize" {{ old('unit_type', $product->unit_type) == 'Uncustomize' ? 'selected' : '' }}>Jerrycan</option>
                        </select>
