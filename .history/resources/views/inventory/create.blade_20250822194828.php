            ...
            <div class="p-6">
                <form method="POST" action="{{ route('inventory.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="unit_type" id="unit_type" required class="mt-1 appearance-auto block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                            <option value="" hidden></option>
                            <option value="Customize">Customize</option>
                            <option value="Uncustomize">Uncustomize</option>
                            '',''
                        </select>
                        @error('unit_type')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    ...
                    <div class="flex justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-6 rounded-md">Add Product</button>
                    </div>
                </form>
            </div>
        </div>
