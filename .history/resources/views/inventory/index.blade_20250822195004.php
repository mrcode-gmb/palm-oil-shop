                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <select id="unit_type" 
                            ...
                            <option value="litre" {{ request('unit_type') == 'Customize' ? 'selected' : '' }}>Customize</option>
                            <option value="jerrycan" {{ request('unit_type') == 'Uncustomize' ? 'selected' : '' }}>Uncustomize</option>
                        </select>
