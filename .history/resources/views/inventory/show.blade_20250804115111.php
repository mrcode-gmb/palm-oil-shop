                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p
                                            class="text-3xl font-bold {{ $product->current_stock == 0 ? 'text-red-600' : ($product->current_stock < 10 ? 'text-yellow-600' : 'text-green-600') }}">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div class="text-center p-3 bg-blue-50 rounded-lg">
                                    ...
                                    <p class="text-lg font-semibold text-blue-800">₦{{ number_format($averageCostPrice, 2) }}
                                    </p>
                                </div>
