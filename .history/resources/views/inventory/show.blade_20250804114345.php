        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                @if(auth()->user()->isAdmin())
                    <a href="{{ route('inventory.edit', $product) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                        Edit Product
                    </a>
                @endif
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Stock Value -->
                            @php
                               echo $averageCostPrice = $product->purchases()->cost_price_per_unit ?? 0;
