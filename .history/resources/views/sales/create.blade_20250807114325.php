        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                <form method="POST" action="{{ route('sales.store') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="quantity" class="block text-sm font-medium text-gray-700">Purchase Price (₦)</label>
                        <input type="number" 
                               id="quantity" 
                               name="quantity" 
                               step="0.01" 
                        ...
                        @error('quantity')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">Enter the selling price to sell</p>
                    </div>
                    </div>
