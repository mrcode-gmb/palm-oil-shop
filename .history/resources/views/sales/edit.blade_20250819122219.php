            ...
            <div class="p-6">
                <form method="POST" action="{{ route('sales.update', $sale) }}" class="space-y-6" id="saleForm">
                        ...
                        <select id="product_id" 
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" 
                                    ...
                                    {{ $product->name }} ({{ ucfirst($product->unit_type) }}) - {{ number_format($product->current_stock, 1) }} available
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Maximum available: <span id="maxQuantity">{{ $sale->purchase>current_stock + $sale->quantity }}</span></p>
                    </div>
