            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">My Total Remainiging Quantity</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($totalRemainingQuantityStock, 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
