                    ...
                    <div>
                        ...
                        <dl class="space-y-3">
                            ...
                            <div>
                                ...
                                <dd class="text-sm text-gray-900">{{ $sale->purchase->product->name }} ({{ ucfirst($sale->product->unit_type) }})</dd>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-medium">{{ $sale->product->name }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600">Unit Type:</span>
                                <span class="text-sm font-medium capitalize">{{ $sale->product->unit_type }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600">Current Stock:</span>
                                <span class="text-sm font-medium {{ $sale->product->current_stock < 10 ? 'text-red-600' : 'text-green-600' }}">
