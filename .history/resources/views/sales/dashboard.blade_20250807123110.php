        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('sales.mySaleRecord') }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-md text-center font-medium transition-colors duration-200">
                        <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @forelse($availableProducts as $product)
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-md">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ ucfirst($product->unit_type) }} • ₦{{ number_format($product->selling_price, 2) }}</p>
                                </div>
                                <div class="text-right">
                                    <p class="text-sm font-medium {{ $product->current_stock < 10 ? 'text-red-600' : 'text-green-600' }}">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('sales.mySaleRecord') }}" class="text-sm text-blue-600 hover:text-blue-500">View all</a>
                    </div>
                    <div class="space-y-3">
