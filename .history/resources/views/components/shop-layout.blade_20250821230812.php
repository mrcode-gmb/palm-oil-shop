...
<body class="font-sans antialiased bg-gray-50">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div id="menuBtn" class="hidden max-md:flex fixed w-10 h-10 bg-white rounded-lg shadow-md right-3 top-2 text-white" onclick="toggleMobileMenu()">
    <!-- Hamburger Icon -->
    <svg id="hamburgerIcon" class="w-6 h-6 text-gray-700 m-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M4 6h16M4 12h16M4 18h16"/>
    </svg>
    <!-- Close Icon -->
    <svg id="closeIcon" class="w-6 h-6 text-gray-700 m-auto hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
