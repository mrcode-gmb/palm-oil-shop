...
<body class="font-sans antialiased bg-gray-50">
    <div class="flex h-screen">
        ...
        <div class="w-64 max-md:hidden max-md:fixed max-md:h-screen transition-all duration-150 -translate-x-6 bg-white shadow-lg">
            <!-- Logo -->
    ...
    <script>
        ...
        function toggleMobileMenu() {
            ...
            if (sidebar.classList.contains("max-md:hidden")) {
                ...
                sidebar.classList.add("-translate-x-6")
            } else {
