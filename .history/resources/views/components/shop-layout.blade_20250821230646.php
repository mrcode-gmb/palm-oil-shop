...
<body class="font-sans antialiased bg-gray-50">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div class="hidden max-md:flex fixed w-10 h-10 bg-white rounded-lg shadow-md right-3 top-2 text-white" onclick="toggleMobileMenu()">
            
            <svg class="w-6 h-6 text-gray-700 m-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
