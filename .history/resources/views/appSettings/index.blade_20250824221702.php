                    ...
                    @forelse($gallery as $galleries)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ $galleries->created_at->format('M d, Y') }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ $galleries->user->name }}
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm text-blue-600 font-medium whitespace-nowrap">
                                ₦{{ number_format($galleries->today_profit, 2) }}
                            </td>
                            <td class="px-6 py-4 text-sm text-blue-600 font-medium whitespace-nowrap">
                                ₦{{ number_format($galleries->amount, 2) }}
                            </td>
                            <td class="px-6 py-4 text-sm text-blue-600 font-medium whitespace-nowrap">
                                ₦{{ number_format($galleries->today_net_profit, 2) }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ $galleries->notes  }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ optional($galleries->user)->name ?? '-' }}
                            </td>
