            ...
            <div class="p-6">
                <form method="POST" action="{{ route('purchases.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="supplier_phone" class="block text-sm font-medium text-gray-700">Supplier Phone (Optional)</label>
                            <input type="tel" 
                                   id="supplier_phone" 
                                   name="supplier_phone" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label for="buying_price_per_unit" class="block text-sm font-medium text-gray-700">Cost Price Per Unit (₦)</label>
                            <input type="number" 
                    ...
                    <div id="total-display" class="hidden bg-green-50 p-4 rounded-md">
                        ...
                        <div class="mt-2 text-center">
                            <p class="text-sm text-gray-600">New Stock Level: <span id="new-stock" class="font-semibold text-blue-600">0</span></p>
                        </div>
                    </div>
                    ...
                    <div>
                        <label for="selling_profit_per_unit" class="block text-sm font-medium text-gray-700">Selling Profit Per Unit (₦)</label>
                        <input type="number" name="selling_profit_per_unit" id="selling_profit_per_unit" step="0.01" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        <a href="{{ route('purchases.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded-md transition-colors duration-200">
                            Cancel
                        </a>
