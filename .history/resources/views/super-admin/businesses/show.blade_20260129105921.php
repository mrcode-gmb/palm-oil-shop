    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-900">Actual profit: <b>₦{{ number_format(($business->wallet->balance + $stats['current_inventory_value'] + $productAssignmentCost) - $business->businessCapital->balance, 2) }}</b></p>
