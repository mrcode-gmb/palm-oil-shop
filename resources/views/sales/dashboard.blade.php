<x-shop-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <x-stat-card title="My Total Assigned Quantity" value="{{ number_format($totalStock, 2) }}" color="green">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                </x-slot>
            </x-stat-card>

            <x-stat-card title="My Total Sold Quantity" value="{{ number_format($totalSoldQuantity, 2) }}" color="green">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                </x-slot>
            </x-stat-card>

            <x-stat-card title="My Total Remaining Quantity" value="{{ number_format($totalRemainingQuantityStock, 2) }}" color="green">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                </x-slot>
            </x-stat-card>

            <x-stat-card title="Today's Sales" value="₦{{ number_format($todaySales, 2) }}" color="green">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                </x-slot>
            </x-stat-card>

            {{-- <x-stat-card title="Today's Profit" value="₦{{ number_format($todayProfit, 2) }}" color="red">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"/>
                </x-slot>
            </x-stat-card> --}}

            <x-stat-card title="Total Credit Sales" value="₦{{ number_format($totalCreditSales, 2) }}" color="orange">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a2 2 0 002-2V9a2 2 0 00-2-2h-3.382a1 1 0 01-.94-.66L11.5 3.34a1 1 0 00-1.88 0L8.382 7.34A1 1 0 017.44 8H4a2 2 0 00-2 2v6a2 2 0 002 2z"/>
                </x-slot>
            </x-stat-card>

            <x-stat-card title="Monthly Sales" value="₦{{ number_format($monthlySales, 2) }}" color="purple">
                <x-slot name="icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </x-slot>
            </x-stat-card>

            {{-- <x-stat-card title="Monthly Profit" value="₦{{ number_format($monthlyProfit, 2) }}" color="indigo">
                <x-slot name="icon">
